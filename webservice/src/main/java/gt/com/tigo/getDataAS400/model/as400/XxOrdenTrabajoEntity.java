...
@Entity
public class XxOrdenTrabajoEntity extends AbstractEntity {
    private long noOrdenTrabajo;
    ...
    @Id
    public long getNoOrdenTrabajo() {
        return noOrdenTrabajo;
    }

    public void setNoOrdenTrabajo(long noOrdenTrabajo) {
